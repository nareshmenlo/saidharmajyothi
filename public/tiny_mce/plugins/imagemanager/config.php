<?php
	...
	// Authenication
	//comment here//$mcImageManagerConfig['authenticator'] = "SessionAuthenticator";
	//comment here//$mcImageManagerConfig['authenticator.login_page'] = "login_session_auth.php";
	//comment here//$mcImageManagerConfig['authenticator.allow_override'] = "*";
