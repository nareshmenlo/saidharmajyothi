...
Class User_model extends CI_Model
{
	...
	function view_lakshadeepaharatiimg()
	{
		//$this->db->order_by('sno','desc');
	...
	function lakshadeepaharati_form()
	{
		...
		foreach($row as $rec)
		{
			...
			$participationmm=$this->input->post('participation');
			if($participationmm!='') {
			$participation=implode(',',$this->input->post('participation'));
			}
			...
			$subject = "APPLICATION FOR PARTICIPANT DETAILS";
			$message = "
		<html>
		<head>
		</head>
	...
	<tr><td>Phone Mumber: </td><td>$mobile </td></tr>
	<tr><td>Events Participation: </td><td>$participation </td></tr>
