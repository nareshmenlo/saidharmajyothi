<?php
class t_gurubandham extends CI_Controller {
	...
	public function index()
	{
	  ...
	  $data['view_image1']=$this->user_model->view_telugucontent(5);
	  $data['view_image2']=$this->user_model->view_telugucontent(6);
	  $data['view_image3']=$this->user_model->view_telugucontent(7);
	  ...
	  $this->load->view('telugu/t-gurubandham',$data);
	}
}
?>