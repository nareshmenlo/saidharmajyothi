<?php
class t_saidharmajyothi extends CI_Controller {
	...
	public function index()
	{
	  ...
	  $data['view_image1']=$this->user_model->view_telugucontent(2);
	  $data['view_image2']=$this->user_model->view_telugucontent(3);
	  $data['view_image3']=$this->user_model->view_telugucontent(4);
	  ...
	  $this->load->view('telugu/t-saidharmajyothi',$data);
	}
}
?>