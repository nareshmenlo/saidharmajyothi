<?php
class t_photogallery extends CI_Controller {
	...
	public function index()
	{
	  ...
	  $data['view_content']=$this->user_model->view_content(13);
	  $data['view_image1']=$this->user_model->view_telugucontent(14);
	  ...
	  $this->load->view('telugu/t-photogallery_new',$data);
	}
	
	function t_subphotogallery($id)
	{
	  ...
	  $data['view_clients']=$this->user_model->view_clients();
	  $data['view_links']=$this->user_model->view_links();
	  $this->load->view('telugu/t-photogallery',$data);
	}
