<?php
class t_nityaacharaneeyadharmamulu extends CI_Controller {
	...
	public function index()
	{
	  ...
	  $data['view_nithya']=$this->user_model->view_nithya_telugu();
	  ...
	  $this->load->view('telugu/t-nityaacharaneeyadharmamulu',$data);
	}
}
?>