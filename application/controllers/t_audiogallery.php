<?php
class t_audiogallery extends CI_Controller {
	...
	public function index()
	{
	  ...
	  $data['view_audiogallery']=$this->user_model->view_audiogallery(2);
	  ...
	  $this->load->view('telugu/t_audiogallery',$data);
	}
	
	
	function t_saipravanchanalu($id)
	{
	  ...
	  $data['view_clients']=$this->user_model->view_clients();
	  $data['view_links']=$this->user_model->view_links();
	  $this->load->view('telugu/t_saipravanchanalu',$data);
	}
