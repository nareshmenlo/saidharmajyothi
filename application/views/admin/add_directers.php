					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>Add Directers</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/add_directers" method="post" class="form-horizontal" enctype="multipart/form-data">
                             ...
                             <div class="control-group">
                                    ...
                                    <div class="control-group">
                                       <label class="control-label">Directer Image</label>
                                       <div class="controls">
