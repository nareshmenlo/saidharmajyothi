...
<body class="fixed-top">
	...
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href=""> Edit Google Analytics Code</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>Edit Google Analytics Code</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/edit_analytics_code" method="post" class="form-horizontal" enctype="multipart/form-data">
                                   <?php
                                   ...
                                   <!--<div class="control-group">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                           <textarea  name="google"  rows="5" cols="30" class="m-wrap medium" /><?php echo stripslashes($rec->google); ?></textarea>
