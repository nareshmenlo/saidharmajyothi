					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>Edit Contact Details</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/edit_group" method="post" class="form-horizontal" enctype="multipart/form-data">
                           ...
                           <input type="text" name="phone" placeholder="Phone" class="m-wrap medium" value="<?php echo $rec->phone; ?>" />
                               <div style="color:#F00"><?php echo form_error('phone'); ?></div>  
                                         ...
                                         <!--<div class="control-group">
                                       <label class="control-label">Mobele Number</label>
                                       <div class="controls">
                           <input  name="name" placeholder="" class="m-wrap medium" type="text" value="<?php echo ($rec->name); ?>">
                               <div style="color:#F00"><?php echo form_error('address'); ?></div>  
                                       ...
                                       <div class="controls">
                           <input  name="type" placeholder="" class="m-wrap medium" type="text" value="<?php echo ($rec->type); ?>">
                               <div style="color:#F00"><?php echo form_error('address'); ?></div>  
                                       </div>
                                       </div>
