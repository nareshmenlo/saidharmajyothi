					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i> E-Brochure</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								WHY RAMKY</i>
										...
										PHOTOS
                                         ...
                                         <li>
                                        	<a href="<?php echo base_url(); ?>admin/e_brochure/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="rb">
										E-BROCHURE
										</button></a>
                                        </li>
...
<div class="btn-group">
<a href="<?php echo base_url(); ?>admin/add_brochure_view/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="btn green">Add New <i class="icon-plus"></i>
</button></a>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									<thead>
										<tr>
											<th>sno</th>
                                           <th>E-Brochure Link</th>
                                            <th>E-Brochure Pdf</th>
                                            <th>Edit</th>
                                            <th>Delete</th>
									...
									<tbody>
									  ...
									  $i=1;
										...
										?>
                                            ...
                                            <td><a class="vimeo" href="<?php echo base_url(); ?>public/brochure/<?php echo $row->image; ?>" target="_blank">
                                            <img src="<?php echo base_url(); ?>public/img/pdf.jpg" height="80" width="200"></a></td>
                                            
                                           <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_brochure_view/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Edit</a></td>
										    <td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_projects_brochure/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Delete</a></td>
									 </tbody>
                                     <?php $i++;  } ?>
								     </table>
							         </div>
