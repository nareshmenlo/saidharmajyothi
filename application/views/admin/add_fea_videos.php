					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/add_feavideo" method="post" class="form-horizontal" enctype="multipart/form-data">
                                   ...
                                   <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" name="link" placeholder="Link" class="m-wrap medium"  value="<?php echo set_value('link'); ?>"/>
                                    ...
                                    <div class="form-actions">
                                      ...
                                      <a href="<?php echo base_url(); ?>admin/select_feavideo"><button type="button" class="btn">Cancel</button></a>
                                    </div>
