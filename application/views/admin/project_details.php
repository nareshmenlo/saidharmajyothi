					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i> View Features</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                                ...
                                <div class="btn-group">
                                	<ul class="rlist">
                                         ...
                                         <li>
                                        	<a href="<?php echo base_url(); ?>admin/project_details/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="rb">
										FEATURES</i>
										</button></a>
                                        </li>
...
<div class="btn-group">
<a href="<?php echo base_url(); ?>admin/add_project_details_view/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="btn green">Add New <i class="icon-plus"></i>
</button></a>
									...
									<tbody>
									  ...
									  $i=1;
										...
										?>
                                            ...
                                            <?php if($row->image!='') { ?>
                                            <td><img src="<?php echo base_url(); ?>public/brochure/<?php echo $row->image; ?>" height="80" width="200"></td>
                                            <?php } else { ?><td></td><?php } ?>
                                            <td><?php echo stripslashes($row->content); ?></td>
                                            
                                           <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_project_details_view/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Edit</a></td>
										    <td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_project_details/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Delete</a></td>
									 </tbody>
                                     <?php $i++;  } ?>
								     </table>
							         </div>
