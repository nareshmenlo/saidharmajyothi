...
?>
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="">View Agency Registration</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>View Agency Registration</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                               ...
                               <!--  <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_news_view/<?php echo $rec->sno; ?>">Edit</a></td>-->
										<td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_agency_registration/<?php echo $rec->sno; ?>">Delete</a></td>
									</tbody>
                                     <?php $i++;  } ?>
								</table>
                                <?php echo $links ?>
