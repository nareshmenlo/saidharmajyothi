					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i> Slider Images</h4>
								<div class="tools">
                                ...
                                <div class="btn-group">
                                    ...
                                    <li>
										...
										FEATURES</i>
                                         ...
                                         <li>
                                        	<a href="<?php echo base_url(); ?>admin/slider/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="rb">
										SLIDER IMAGES
										</button></a>
                                        </li>
...
<div class="btn-group">
<a href="<?php echo base_url(); ?>admin/add_slider_view/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="btn green">Add New <i class="icon-plus"></i>
</button></a>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
									  ...
									  $i=1;
										...
										?>
											<td><?php echo $i; ?></td>
                                            <td><img src="<?php echo base_url(); ?>public/slider/<?php echo $row->image; ?>" height="80" width="200"></td>
                                            
                                           <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_slider_view/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Edit</a></td>
										    <td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_projects_slider/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Delete</a></td>
									 </tbody>
                                     <?php $i++;  } ?>
								     </table>
							         </div>
