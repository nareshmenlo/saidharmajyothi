					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i> Amentics   </h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								WHY RAMKY</i>
                                        ...
                                        <li>
                                        	<a href="<?php echo base_url(); ?>admin/amentics/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="rb">
										AMENITIES
										</button></a>
                                        </li>
                                        <li>
...
<div class="btn-group">
<a href="<?php echo base_url(); ?>admin/add_amentics_view/<?php echo $sno; ?>"><button id="sample_editable_1_new" class="btn green">Add New <i class="icon-plus"></i>
</button></a>
									...
									<tbody>
									  ...
									  $i=1;
										...
										?>
                                           ...
                                           <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_amentics_view/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Edit</a></td>
										    <td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_projects_amentics/<?php echo $row->sno; ?>/<?php echo $sno;  ?>">Delete</a></td>
									 </tbody>
                                     <?php $i++;  } ?>
								     </table>
							         </div>
