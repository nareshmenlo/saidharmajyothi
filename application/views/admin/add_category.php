...
?>
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="">Add News Category</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>Add News  Category</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/add_category" method="post" class="form-horizontal" enctype="multipart/form-data">
                                   ...
                                   <!--<div class="control-group">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                           <input type="text" name="name" placeholder="Category" class="m-wrap medium" value="<?php echo set_value('name'); ?>" />
