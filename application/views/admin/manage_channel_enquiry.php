...
?>
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="">View Channel Partner Enquiry</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>View Channel Partner Enquiry</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									<thead>
										<tr>
											<th>sno</th>
											<th>Name of Channel Partner/ Property Consultancy Firm</th>
											<th>Year of Establishment</th>
                                            <th>Type of Property Dealt</th>
                               ...
                               <!--  <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_news_view/<?php echo $rec->sno; ?>">Edit</a></td>-->
										<td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_chennel_enquiry/<?php echo $rec->sno; ?>">Delete</a></td>
									</tbody>
                                     <?php $i++;  } ?>
								</table>
                                <?php echo $links ?>
