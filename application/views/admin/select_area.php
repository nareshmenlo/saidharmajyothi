					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>View Categories</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <div class="btn-group">
										<a href="<?php echo base_url(); ?>admin/add_aera_view"><button id="sample_editable_1_new" class="btn green">
									...
									<tbody>
									  ...
									  $i=$page+1;
										...
										?>
                                            ...
                                            <!-- <td><a class="vimeo" href="<?php echo base_url(); ?>admin/view_area_popup/<?php echo $rec->sno; ?>"
                                             title="">View</a></td>-->
                                       <td><a  class="delete" href="<?php echo base_url(); ?>admin/edit_area_view/<?php echo $rec->sno; ?>">Edit</a></td>
										<td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_area/<?php echo $rec->sno; ?>">Delete</a></td>
									</tbody>
                                     <?php $i++;  } ?>
								</table>
                                <?php echo $links; ?>
