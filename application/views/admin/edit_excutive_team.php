...
?>
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="">Edit Excutive Team </a></li>
						</ul>
                ...
                <div class="tab-pane" id="tab_1_4">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>Edit Excutive Team </h4>
								<div class="tools">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/edit_excutive" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<img src="<?php echo base_url(); ?>public/excutive/<?php echo $rec->image; ?>" width="231" height='140' alt="" />
													</div>
													</div>
                                   ...
                                   <div class="space10"></div>
                                       ...
                                       <div class="controls">
                                         <textarea name="content"   id=""  ><?php echo stripslashes($rec->content); ?></textarea>
                                       </div>
                                       </div>
																<div class="space10"></div>
                                    </div>
