...
?>
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="">Edit Our Programes</a></li>
						</ul>
                ...
                <div class="tab-pane" id="tab_1_4">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>Edit Our Programes</h4>
								<div class="tools">
							...
							<div class="portlet-body">
                             ...
                             <form action="<?php echo base_url(); ?>admin/edit_products" method="post" class="form-horizontal" enctype="multipart/form-data">
                                  ...
                                  <!--<div class="control-group">
                                       ...
                                       <div class="controls">
                                         <input type="text" name="name"  id="event" class="medium m-wrap" value="<?php echo $rec->name; ?>">
                                       </div>
                                    </div>
                                    ...
                                    <!--<div class="control-group">
                                       ...
                                       <div class="controls">
                                         <input type="text" name="link"  id="event" class="medium m-wrap" value="<?php echo $rec->link; ?>">
                                       </div>
                                    </div>-->
					...
					<img src="<?php echo base_url(); ?>public/products/<?php echo $rec->pdf; ?>" style="width:200px; height:100px;" alt="" />
													</div>
													</div>
                                                    <?php } ?>
					...
					<img src="<?php echo base_url(); ?>public/products/<?php echo $rec->image; ?>" width="231" height='140' alt="" />
													</div>
													</div>
                                   ...
                                   <div class="space10"></div>
                                    ...
                                    <!--<div class="control-group">
                                       ...
                                       <div class="controls">
                                      <textarea class="medium m-wrap" name="content1"><?php echo stripslashes($rec->content1); ?></textarea>
                                    ...
                                    <!--<div class="control-group">
                                       ...
                                       <div class="controls">
                                      <textarea class="medium m-wrap" name="content2"><?php echo stripslashes($rec->content2); ?></textarea>
