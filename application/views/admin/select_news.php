...
?>
	<!-- END BEGIN STYLE CUSTOMIZER --> 
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo base_url(); ?>admin/select_news">View Latest News</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-edit"></i>View Latest News</h4>
								<div class="tools">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
									  ...
									  $i=$page+1;
										...
										?>
                                            ...
                                            <td><?php echo stripslashes($rec->description); ?></td>
                                 ...
                                 <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_news_view/<?php echo $rec->sno; ?>">Edit</a></td>
									<td><a onclick="return confirm('Are You Sure')" class="delete"
                                             href="<?php echo base_url(); ?>admin/delete_news/<?php echo  $rec->sno; ?>">Delete</a></td>
									</tbody>
                                     <?php $i++;  } ?>
								</table>
                                <?php echo $links ?>
