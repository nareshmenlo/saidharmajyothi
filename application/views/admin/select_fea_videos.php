					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <!--<div class="btn-group">
										<a href="<?php echo base_url(); ?>admin/add_feavideos_view"><button id="sample_editable_1_new" class="btn green">
                             ...
                             <td><a class="edit" href="<?php echo base_url(); ?>admin/edit_feavideo_view/<?php echo $rec->sno;  ?>">Edit</a></td>
