...
<div id="wrapper">
 ...
 <section id="page-info" class="container-fluid">
			<div class="row">
				<div class="img-area">
					<div class="holder"><img src="<?php echo base_url(); ?>public/images/subpagebanner6.jpg" width="1600" height="196" alt="" />
					</div>
				</div>
      ...
      <div class="row">
       <section class="col-lg-3 col-xs-12 col-sm-6 media"> 
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 midcontent">
        	<img src="<?php echo base_url(); ?>public/apartments/<?php echo $view_image1['image']; ?>" alt="" class="telimgresp">
      	</div>
        <!-- upcoming events -->
      </div>
    </div>
