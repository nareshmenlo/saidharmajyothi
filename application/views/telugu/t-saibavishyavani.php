...
<div id="wrapper">
 ...
 <section id="page-info" class="container-fluid">
			<div class="row">
				<div class="img-area">
					<div class="holder"><img src="<?php echo base_url(); ?>public/images/subpagebanner8.jpg" width="1600" height="196" alt="" />
					</div>
				</div>
