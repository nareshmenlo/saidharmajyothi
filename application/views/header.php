            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="#">Programmes</a>
				...
				?>
                    ...
                    <?php } ?>
                   <li><a href="<?php echo base_url(); ?>ourprogrames">Our Programmes</a></li>
                </ul>
              </li>
              <?php /*?><li><a href="<?php echo base_url(); ?>recentevents">Recent Events</a></li><?php */?>
              <li><a href="<?php echo base_url(); ?>lakshadeepaharati">Laksha Deepa Harati</a></li>
