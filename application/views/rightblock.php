 <section class="col-lg-3 col-xs-12 col-sm-6 media"> 
         	 <a href="#" class="btn btnsidebar btn-default"><i class="fa fa-bookmark"></i> Prayer By Founder</a>
            <!--<a href="#" class="btn btnsidebar btn-default"><i class="fa fa-trophy"></i> Awards &amp; Achievements</a>-->
            <a href="#" class="btn btnsidebar btn-default"><i class="fa fa-pencil-square-o"></i> Prayer Request</a>
            <a href="#" class="btn btnsidebar btn-default"><i class="fa fa-paypal"></i> Paypal (Online Donations)</a>
        </section>
...
<section class="col-lg-3 col-xs-12 col-sm-6 marspace"> 
