...
<div id="wrapper">
 ...
 <section id="page-info" class="container-fluid">
			<div class="row">
				<div class="img-area">
					<div class="holder"><img src="<?php echo base_url(); ?>public/images/subpagebanner.jpg" width="1600" height="196" alt="" />
					</div>
				</div>
    ...
    <div class="container topmargpad">
      <div class="row">
       <section class="col-lg-3 col-xs-12 col-sm-6 media"> 
        ...
        <!-- blogs -->
        <div class="col-lg-9 col-md-9 col-sm-9 midcontent">        
